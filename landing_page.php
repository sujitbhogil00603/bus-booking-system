...
<head>
    ...
    <style>
        ...
        html {
            background-image: url('bus.jpg'); /* Replace 'background_image.jpg' with the path to your image */
            background-size: cover;
            background-repeat: no-repeat;
            font-family: Arial, sans-serif; /* Optional: Specify a font-family for better readability */
...
<body>
    ...
    <br><br>
    <form action="passengerinfo.php" method="post" class="secondform">
        <?php
        if (isset($_POST['submit'])) {
            ...
            $db = mysqli_connect('localhost:3306', 'root', 'Pass@123', 'online_bus') or die("Could not connect to Database");
